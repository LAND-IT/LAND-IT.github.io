...
import RelatedPublications from '../components/presentational/RelatedPublications';
import {Team} from '../components/presentational/Team';
import {translate} from '@docusaurus/Translate';
import {Header} from '../components/layouts/Header';
import OpenSourceProjects from "../components/presentational/OpenSourceProjects";
...
const sections = [
    ...
    {id: "related_publications", label: translate({id: "sections.related_publications"}), body: <RelatedPublications/>},
    {id: "open_source_projects", label: translate({id: "sections.open_source"}), body: <OpenSourceProjects/>},
